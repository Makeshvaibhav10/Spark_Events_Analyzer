...
| KPI | Value | Status |
|-----|-------|--------|
| CPU Efficiency | 36.03% | 🔴 Poor |
| GC Overhead | 24.18% | 🔴 Poor |
| Shuffle Efficiency | 1.000 | ✅ Good |
| Memory Spilled | 1.52 GB | 🔴 High |

## 🔍 Identified Bottlenecks (4)

### 1. 🔴 Memory Spill to Disk
...
### 4. 🟠 CPU Underutilization / CPU Underutilization
